<x-filament::widget>
    @if (! $readyToLoad)
        <div class="flex justify-center items-center w-full h-full bg-white dark:bg-gray-800 rounded-xl border border-gray-200/70 dark:border-gray-700 p-6" wire:init="loadWidget">
